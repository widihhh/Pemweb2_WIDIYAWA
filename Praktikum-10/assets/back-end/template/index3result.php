...
<head>
  ...
  <title>WebAdmin | Praktikum 3</title>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            if (!empty($proses)) {
              ...
              echo '<br/>Total Nilai Akhir : ' . $total;
            }
            ...
            <button class="btn btn-success">
              <a class="fa fa-backward text-decoration-none text-white" href="index3.php" aria-hidden="true" style="font-size: large;">&ensp;Back</a>
            </button>
          </div>
          <!-- /.card-body -->
