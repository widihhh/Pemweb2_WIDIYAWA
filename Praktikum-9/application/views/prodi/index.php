                                ...
                                <tbody style="border-bottom: 1px solid white; border-right: 1px solid white; border-left: 1px solid white;">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row->kaprodi ?></td>
                                            <td>
                                                <a class="btn btn-info" href="<?= base_url(); ?>prodi/detail/<?= $row->id; ?>">Detail</a>
                                                <a class="btn btn-success" href="<?= base_url(); ?>prodi/halaman_edit/<?= $row->id; ?>">Edit</a>
                                                <a class="btn btn-danger" href="<?= base_url(); ?>prodi/delete_prodi/<?= $row->id; ?>" onclick="return hapus('Yakin ingin menghapus data <?= $row->nama; ?>')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                        $nomor++;
